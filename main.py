...
parser.add_argument('--result_dir', default='results_new')
...
vid_list_file = "../MS_TCN2/data/"+args.dataset + \
    "/splits/train.split"+args.split+".bundle"
vid_list_file_tst = "../MS_TCN2/data/"+args.dataset + \
...
trainer = Trainer(num_layers, 2, 2, num_f_maps, features_dim,
                  num_classes, channel_mask_rate)
...
if args.action == "predict":
    ...
    trainer.predict(model_dir, results_dir, features_path,
                    batch_gen_tst, num_epochs, actions_dict, sample_rate)
